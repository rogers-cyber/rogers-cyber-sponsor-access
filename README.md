...
| VID2IMG Pro | Video to Image Extraction & Anonymization Tool with face privacy, 360° & photogrammetry support. | [GitHub](https://github.com/rogers-cyber/vid2img) | ![Execution](https://img.shields.io/badge/Status-Execution-orange) |
...
| Clipboard Manager GUI | Full-featured clipboard manager with history, search, export/import, and global hotkeys. | [GitHub](https://github.com/rogers-cyber/Clipboard-Manager-GUI-Full-Python-Source) | ![Execution](https://img.shields.io/badge/Status-Execution-orange) |
| Enterprise Bulk Rename GUI | Enterprise-grade bulk file renaming tool with preview, undo, and advanced patterns. | [GitHub](https://github.com/rogers-cyber/Enterprise-Bulk-Rename-GUI-Python) | ![Execution](https://img.shields.io/badge/Status-Execution-orange) |
